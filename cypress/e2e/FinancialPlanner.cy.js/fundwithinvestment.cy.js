...
describe("try", () => {
  ...
  it("TC_FP_01 - Verify View Expenses Of label ", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
  ...
  it("TC_FP_FundwithInvest_03 - Select View Expenses Primary from Dropdown", () => {
    cy.url().should("include", "fund_with_investment");
    cy.visit(
      "https://publicplan.aivante.net/New_FP/Dzee/financial_planner/planner#fund_with_investment"
    );
  ...
  it("TC_FP_FundwithInvest_04 - Verify Primary Name Displayed", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.verifyDropdownOptions();
    fundwithinvestmentPage.selectviewexpenseprimary();
  ...
  it("TC_FP_FundwithInvest_05 - Verify View Input Button", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.VerifyViewInputButton();
  });
  it("TC_FP_FundwithInvest_06 - Click On View Input Button", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.ClickViewInputButton();
  });

  it("TC_FP_FundwithInvest_07 - Verify PV for Total Healthcare expenses ", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.verifyPVforTotalHealthcareExpenses();
    cy.log("PV for Total Healthcare expenses label verified");
  });

  it("TC_FP_FundwithInvest_08 - Verify Age Expenses Begin", () => {
    cy.url().should("include", "fund_with_investment");
  ...
  it("TC_FP_FundwithInvest_09  - Verify Percentage of Healthcare Goal to Fund", () => {
    cy.url().should("include", "fund_with_investment");
  ...
  it("TC_FP_FundwithInvest_10 - Verify Stepper for Percentage of Healthcare Goal to Fund", () => {
    cy.url().should("include", "fund_with_investment");
  ...
  it("TC_FP_FundwithInvest_25 - Verify Annual Expenses Checkbox", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
  ...
  it("TC_FP_FundwithInvest_26 - Verify Year-end Healthcare Savings Balance Checkbox", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
  ...
  it("TC_FP_FundwithInvest_33 - Verify Age Expenses Begin for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
    fundwithinvestmentPage.VerifyAgeExpensesBeginSpouse();
    cy.log("Age Expenses Begin for Spouse verified");
  });
  it("TC_FP_FundwithInvest_34 - Verify Percentage of Healthcare Goal to Fund for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
  ...
  it("TC_FP_FundwithInvest_35 - Verify Stepper for Percentage of Healthcare Goal to Fund for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
  ...
  it("TC_FP_FundwithInvest_36 - Verify PV for Expenses to Fund for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
    fundwithinvestmentPage.VerifyPVForExpensesToFundSpouse();
    cy.log("PV for Expenses to Fund for Spouse verified");
  });
  it("TC_FP_FundwithInvest_37 - Verify PV for Expenses not Funded for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
    fundwithinvestmentPage.VerifyPVForExpensesnotFundedSpouse();
    cy.log("PV for Expenses not Funded for Spouse verified");
  });
  it("TC_FP_FundwithInvest_38 - Verify Current Savings Allocated to Healthcare for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
  ...
  it("TC_FP_FundwithInvest_39 - Select Investment Profile Dropdown for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
    fundwithinvestmentPage.Checkspousename();
    //fundwithinvestmentPage.VerifyInvestmentProfileDropdownOptions();
  ...
  it("TC_FP_FundwithInvest_46 - Verify Annual Savings for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
    fundwithinvestmentPage.clickCalculateSavingsButtonSpouse();
  ...
  it("TC_FP_FundwithInvest_47 - Verify Annual Expenses Required for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
    fundwithinvestmentPage.clickCalculateSavingsButtonSpouse();
  ...
  it("TC_FP_FundwithInvest_48 - Verify Year-end Healthcare Savings Balance for Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
    fundwithinvestmentPage.clickCalculateSavingsButtonSpouse();
  ...
  it("TC_FP_FundwithInvest_49 - Retirement age of Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
    fundwithinvestmentPage.clickCalculateSavingsButtonSpouse();
  ...
  it("TC_FP_FundwithInvest_50 - Medicare Eligibility Age of Spouse", () => {
    const fundwithinvestmentPage = new Fundwithinvestment();
    fundwithinvestmentPage.SelectviewexpenseSpouse();
    fundwithinvestmentPage.clickCalculateSavingsButtonSpouse();
